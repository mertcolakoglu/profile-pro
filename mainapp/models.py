...
class GeneralSettings(models.Model):
    ...
    description = models.TextField(default='', max_length=254, blank=True, verbose_name='Description', help_text='Description',)
    parameters = models.CharField(default='',max_length=254, blank=True, verbose_name='Parameters', help_text='Parameters',)
